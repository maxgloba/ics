  ...
  <header class="header">
    <div class="container">
      ...
      <nav class="header-menu">
        <nuxt-link to="https://nft-storks.creator-spring.com/">
        ...
        <nuxt-link to="https://medium.com/@nftstorks">
          <svg width="38" height="30" viewBox="0 0 38 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.58676 6.11993C4.63371 5.65605 4.45681 5.19757 4.11043 4.88536L0.582099 0.63492V0H11.5376L20.0056 18.5714L27.4504 0H37.8942V0.63492L34.8775 3.52734C34.6174 3.72558 34.4884 4.05141 34.5423 4.3739V25.6261C34.4884 25.9486 34.6174 26.2744 34.8775 26.4727L37.8237 29.3651V30H23.0047V29.3651L26.0567 26.4021C26.3566 26.1023 26.3566 26.0141 26.3566 25.5556V8.37743L17.8709 29.9295H16.7242L6.84489 8.37743V22.8219C6.76252 23.4292 6.96421 24.0406 7.39178 24.4797L11.3612 29.2945V29.9295H0.105774V29.2945L4.07515 24.4797C4.49961 24.0398 4.68954 23.4244 4.58676 22.8219V6.11993Z" fill="#7B61FF"/>
          </svg>
        </nuxt-link>
        <nuxt-link to="https://twitter.com/nftstorks">
